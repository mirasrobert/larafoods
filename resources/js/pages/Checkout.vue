<template>
    <div class="container pb-10 pt-3">
        <h1 class="text-3xl font-bold text-center mb-16">Checkout</h1>
        <div
            class="w-full grid grid-col-1 lg:grid-cols-[750px_minmax(450px,_1fr)_100px] gap-8">
            <div class="overflow-x-auto overflow-y-hidden">
                            ...
                            <div class="pl-5">
                                ...
                                <div class="flex flex-col justify-between h-full">
                                    <ul class="mt-2">
                                        ...
                                        <li>
                                            <span class="font-normal text-gray-600">Qty:</span>
                                            1
                                        </li>
                                    </ul>
                ...
                <div class="pt-8 px-3">
                    <p class="font-semibold text-lg mb-6">Shipping Options</p>
                    <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <Label labelFor="province" text="Province"/>
                            <select
                                id="province"
                    ...
                    <div class="mb-6 grid-cols-1 grid md:grid-cols-2 gap-6">
                        <div>
                            <Label labelFor="barangay" text="Barangay"/>
                            <select
                                id="barangay"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        ...
                        <div>
                            <Label labelFor="province" text="Street Address"/>
                            <Input type="text" placeholder="House no & street"/>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Discount Option and Order Summary -->
            <div class="w-full h-full">
                <div class="bg-gray-50 rounded-lg">
                    <div class="px-8 pt-8">
                        <p class="font-semibold text-lg mb-6">Discount Options</p>
                        <div class="mb-6">
                            <Label
                                labelFor="province"
                            ...
                            <div class="flex rounded-md shadow-sm">
                                <input type="text" placeholder="Discount code" name="discount_code"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <button type="button"
                                        class="inline-flex flex-shrink-0 justify-center items-center px-5 rounded-r-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm">
                                    Apply
                                </button>
                            </div>
                        </div>
                        <div class="mb-6">
                            ...
                            >
                                ...
                                <option value="US">PayPal or Debit Card</option>
                                <option value="CA">Cash on Delivery</option>
                            </select>
                        </div>
                    </div>
                    <div class="px-8 pb-8">
                        ...
                        <div class="flex justify-between mb-2">
                            <Label
                                ...
                                text="Discount"
                            />
                            <p class="text-gray-600">(20%) - $16.19</p>
                        </div>
                        <div class="flex justify-between mb-2">
                            <Label
                                class="font-semibold"
            ...
            <!-- End Discount Option and Order Summary -->
        </div>
    </div>
</template>
